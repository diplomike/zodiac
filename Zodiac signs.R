library(tidyverse)
library(usethis) 'For using use_github'
...
quantile(acc, 0.99) 'Indicate the accuracy above which the population only constitutes to 1% of the total.'

use_github() 'To create a remote repo on Github.'